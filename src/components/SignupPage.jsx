...
const SignupPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!password) {
            ...
            newErrors.password = "Password must contain a character, symbol, and number.";
        }
        ...
        <div className="flex flex-col md:flex-row h-screen w-full bg-gray-100">
            ...
            <div className="md:w-1/3 bg-blue-500 text-white flex flex-col items-center justify-center p-8">
                <div className="flex flex-col ml-10 justify-center">
                    ...
                    <h1 className="text-4xl font-bold mb-2">We simply your finacial handlings</h1>
                    <h4 className="text-lg text-left">Join us to explore amazing opportunities!</h4>
                </div>
            </div>

            {/* Form Section */}
            <div className="md:w-2/3 bg-white flex items-center justify-center p-8">
                <form className="w-full max-w-md bg-white shadow-lg p-6 rounded-lg" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-500">Make sure it match the name on your NIN card</p>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-500">Make sure it contains special character, symbor and numbers</p>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-500">You will receive an OTP on your phone.</p>
                    </div>
